...
usb:
	$(TYPE) -c Src/releve.c Src/commande.c Src/simulateur.c Src/usb.c Src/consigne.c Src/autotests.c Src/regulation.c Src/visualisationC.c Src/visualisationT.c Src/test_usb.c -Wall 
	$(TYPE) autotests.o commande.o consigne.o test_usb.o regulation.o releve.o simulateur.o usb.o visualisationC.o visualisationT.o Lib/ftd2xx.lib -o execute -Wall
	./execute.exe
	make clean
